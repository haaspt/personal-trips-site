...
import './index.css';
import {ResumeLink} from './pthaas_resume.pdf';
  ...
  render () {
    return (
      <div id="side-panel">
        ...
        <p>Check out my <a href="https://github.com/haaspt">GitHub</a> to see other things I’ve built, or my <a href="https://www.linkedin.com/in/ptylerhaas/">LinkedIn</a> for more about what I’ve worked on, or just check out my <a href={ResumeLink} target="_blank">resume</a>.</p>
        <hr />
